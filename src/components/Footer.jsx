...
const Footer = () => {
  return (
    <footer className="bg-VeryDarkCyan text-white pt-36 px-4 md:px-8 lg:px-16">
      ...
      <div className="md:grid md:grid-cols-4 md:justify-items-center md:mt-10  gap-4">
        <div>
          <div className="flex justify-start items-start gap-8 mt-8 md:mt-0 text-xl">
            <img
              className="pt-2 md:pt-0 w-16 md:w-16 "
          ...
          <div className="flex justify-start items-start gap-8 mt-8 text-xl">
            <img
              className="pt-2 md:pt-0 w-6 "
        ...
        <nav className="md:contents mt-12  text-xl md:col-span-2 ">
        ...
        <div className="flex justify-center md:items-start items-center gap-6 mt-16 md:mt-0 ">
          <div className="border hover:border-Pink hover:text-Pink transition  cursor-pointer  w-10 h-10 flex justify-center items-center  rounded-full border-white ">
            <i className="fa-brands  fa-facebook-f" />
          </div>
          <div className="border  hover:border-Pink hover:text-Pink cursor-pointer w-10 h-10 flex justify-center items-center rounded-full border-white ">
      ...
      <div className="text-center md:flex md:justify-end mt-6 md:mt-10 pb-12">
